...
export const FITBLEND_RECIPES: ProductRecipe[] = [
  { productId: 'SM-01', productName: 'Thanh long thơm', baseIngredients: [milk(), whey()] },
  { productId: 'SM-02', productName: 'Thanh long xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-03', productName: 'Thanh long chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-04', productName: 'Cacao chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-05', productName: 'Cacao yến mạch', baseIngredients: [milk(), whey()] },
  { productId: 'SM-06', productName: 'Lê chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-07', productName: 'Xoài thơm', baseIngredients: [milk(), whey()] },
  { productId: 'SM-08', productName: 'Xoài chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-09', productName: 'Xoài cam', baseIngredients: [milk(), whey()] },
  { productId: 'SM-10', productName: 'Chanh dây xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-11', productName: 'Cacao xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-12', productName: 'Bơ chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-13', productName: 'Dâu chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-14', productName: 'Xoài dâu', baseIngredients: [milk(), whey()] },
  { productId: 'SM-15', productName: 'Đu đủ xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-16', productName: 'Đu đủ thơm', baseIngredients: [milk(), whey()] },
  { productId: 'SM-17', productName: 'Đu đủ chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-18', productName: 'Matcha xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-19', productName: 'Matcha chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-20', productName: 'Việt quất chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-21', productName: 'Việt quất xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-22', productName: 'Việt quất đu đủ', baseIngredients: [milk(), whey()] },
  { productId: 'SM-23', productName: 'Chuối cam', baseIngredients: [milk(), whey()] },
  { productId: 'SM-24', productName: 'Chuối bơ đậu phộng', baseIngredients: [milk(), whey()] },
  { productId: 'SM-25', productName: 'Cải Kale táo', baseIngredients: [milk(), whey()] },
  { productId: 'SM-26', productName: 'Cải Kale xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-27', productName: 'Cải Kale chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-28', productName: 'Mãng cầu xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-29', productName: 'Cà phê chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-30', productName: 'Cacao xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-31', productName: 'Bơ chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-32', productName: 'Nho chuối', baseIngredients: [milk(), whey()] },
  { productId: 'SM-33', productName: 'Dâu tằm xoài', baseIngredients: [milk(), whey()] },
  { productId: 'SM-34', productName: 'Xoài cam', baseIngredients: [milk(), whey()] },
  { productId: 'SM-35', productName: 'Phúc bồn tử chuối', baseIngredients: [milk(), whey()] },
];

...
export const DEFAULT_MENU_BOOK: MenuBookData = {
  ...
  branches: [
    ...
    { district: 'BÌNH THẠNH', address: 'Đường Võ Oanh', ward: '', note: 'Online', noteEn: 'Delivery only' },
    { district: 'BÌNH THẠNH', address: 'Đường Xô Viết Nghệ Tĩnh', ward: '', note: 'Online', noteEn: 'Delivery only' },
  ],
  phone: '0965 351 545',
  web: 'fitblend.vn',
  zalo: '@fitblend',

...
async function init() {
  ...
  const migrations = [
    ...
    "ALTER TABLE orders ADD COLUMN deliveryType TEXT DEFAULT 'delivery'",
    ...
    "ALTER TABLE combo_subscriptions ADD COLUMN deliveryType TEXT DEFAULT 'delivery'",
    "ALTER TABLE combo_subscriptions ADD COLUMN shipMethod TEXT DEFAULT 'own'",
    "ALTER TABLE combo_subscriptions ADD COLUMN shipProvider TEXT",
    "ALTER TABLE combo_subscriptions ADD COLUMN allergyNote TEXT",
    "ALTER TABLE orders ADD COLUMN allergyNote TEXT",
